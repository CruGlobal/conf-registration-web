...
describe('Directive: ertPayment', function () {
  ...
  describe('GIFT_CARD payment validation', () => {
    it('should pass validation with card number of 10 characters', () => {
      scope.currentPayment = {
    ...
    it('should pass validation with card number of 12 characters', () => {
      scope.currentPayment = {
        paymentType: 'GIFT_CARD',
        giftCard: {
          number: '1234567890AB',
    ...
    it('should require card number when empty', () => {
      scope.currentPayment = {
        paymentType: 'GIFT_CARD',
        giftCard: {
          number: '',
    ...
    it('should reject card number with less than 10 characters', () => {
      scope.currentPayment = {
        paymentType: 'GIFT_CARD',
        giftCard: {
          number: '123456789',
    ...
    it('should reject card number with more than 12 characters', () => {
      scope.currentPayment = {
        paymentType: 'GIFT_CARD',
        giftCard: {
