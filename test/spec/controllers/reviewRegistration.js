...
describe('Controller: ReviewRegistrationCtrl', function () {
    var scope, controller, conference, registration;
    ...
    beforeEach(angular.mock.inject(function ($rootScope, $controller) {
        ...
        scope = $rootScope.$new();
        scope.answers = registration.registrants[0].answers;

        controller = $controller('ReviewRegistrationCtrl', {
            $scope: scope, registration: registration, conference: conference
        });
    }));
    ...
    it('blockVisibleForRegistrant should be true', function () {
        expect(scope.blockVisibleForRegistrant(conference.registrationPages[1].blocks[0], registration.registrants[0])).toBe(true);
    });
});