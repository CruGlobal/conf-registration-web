...
angular.module('confRegistrationWebApp').service('testData', function () {
  this.conference = {
    ...
    registrationPages: [
        ...
        blocks: [
          {
            ...
            blockIntegrationId: '7a09d6f3-0c25-4281-aa60-b7702e713b9c',
            title: 'Email',
      ...
      {
        id: '6090fccc-4f01-491b-b53f-f35b2ed3258a',
        conferenceId: 'c63b8abf-52ff-4cc4-afbc-5923b01f1ab0',
        title: 'School Questions',
        position: 0,
        blocks: [
          {
            ...
            content: {
              ...
              choices: [
                ...
                {
                  value: 'radio option - hide child',
                  desc: '',
                  operand: 'OR',
                  $hashKey: 'object:695',
                },
                {
                  value: 'radio option - hide child also',
                  desc: '',
                  operand: 'OR',
                  $hashKey: 'object:696',
                },
          ...
          },
          {
            ...
            content: {
              ...
              choices: [
                {
                  value: 'radio option - show grandchild',
                  desc: '',
                  operand: 'OR',
                  $hashKey: 'object:703',
                },
                {
                  value: 'radio option - hide grandchild',
                  desc: '',
                  operand: 'OR',
                  $hashKey: 'object:704',
                },
                {
                  value: 'radio option - hide grandchild also',
                  desc: '',
                  operand: 'OR',
                  $hashKey: 'object:705',
                },
            ...
            rules: [
              {
                id: '22bc7893-0087-4cc3-8886-b5dc5b483ebb',
                blockId: '38f8ece0-adf7-423d-9588-2222222',
                parentBlockId: 'd6f1b12a-8c98-4e83-8857-1111111',
                operator: '=',
                value: 'radio option - show child',
                position: 0,
                blockEntityOption: '',
          ...
          },
          {
            ...
            pageId: '6090fccc-4f01-491b-b53f-f35b2ed3258a',
            blockIntegrationId: '896c6c02-8285-4d1d-9b1a-e1c6fffa8179',
            ...
            rules: [
              {
                id: '13a95412-334c-4ca7-83ef-757c4365cb55',
                blockId: 'a7acefb9-72ef-4195-9b14-3333333',
                parentBlockId: '38f8ece0-adf7-423d-9588-2222222',
                operator: '=',
                value: 'radio option - show grandchild',
                position: 0,
                blockEntityOption: '',
    ...
    registrantTypes: [
      ...
      },
      {
        ...
        hidden: false,
        createdTimestamp: '2015-07-08T18:42:56.632Z',
        lastUpdatedTimestamp: '2015-07-08T18:42:56.632Z',
        cost: 100,
        minimumDeposit: null,
        earlyRegistrationCutoff: '2015-08-06 00:00:00',
        earlyRegistrationDiscount: false,
        earlyRegistrationAmount: 20,
        allowedRegistrantTypeSet: [
          {
            id: '3867eb78-2d6a-4b00-a075-6e58c816129f',
            name: 'Spouse',
            childRegistrantTypeId: 'a1b2c3d4-e5f6-7890-abcd-1234567890ef',
        ...
        customConfirmationEmailText: '',
        groupSubRegistrantType: false,
        description: 'Couple registration type',
        allowGroupRegistrations: true,
      ...
      // Spouse type related to couple:
      {
        ...
        customConfirmationEmailText: '',
        groupSubRegistrantType: true,
        description: 'Spouse registration type',
        allowGroupRegistrations: false,
        numberSlotsLimit: 100,
        useLimit: false,
        availableSlots: 100,
      ...
      {
        id: 'f3c2e1d4-7b8a-4c6f-9e2b-9876543210fe',
        conferenceId: 'c63b8abf-52ff-4cc4-afbc-5923b01f1ab0',
        name: 'Spouse',
        defaultTypeKey: 'SPOUSE',
        hidden: false,
    ...
    registrants: [
      {
        ...
        answers: [
          ...
          {
            id: '6e52f066-f894-43ac-b9c0-11111111',
            registrantId: '6bd0f946-b010-4ef5-83f0-51c17449baf3',
  ...
  this.coupleRegistration = {
    id: '709738ff-da79-4eed-aacd-d9f005fc7f4e',
    userId: '0c3a1826-9a81-444f-9299-1f6f5288a0cc',
    conferenceId: 'c63b8abf-52ff-4cc4-afbc-5923b01f1ab0',
    groupId: 'Last-709738ff',
    calculatedTotalDue: 50.0,
    calculatedPromotionDiscounts: 0,
    ...
    registrants: [
      ...
      {
        id: 'd9855056-efc8-4ea7-81aa-4b0902376xyz',
        registrationId: '709738ff-da79-4eed-aacd-d9f005fc7f4e',
        userId: '1d3a1826-9a81-444f-9299-1f6f5288a0dd',
        registrantTypeId: 'a1b2c3d4-e5f6-7890-abcd-1234567890ef',
        calculatedTotalDue: 0.0,
        calculatedEarlyRegistrationDiscounts: 0,
        calculatedPromotionDiscounts: 0,
        createdTimestamp: '2018-12-21T10:23:33.494Z',
