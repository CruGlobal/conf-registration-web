...
describe('Service: currentRegistrationInterceptor', function () {
  ...
  beforeEach(inject(function (_currentRegistrationInterceptor_, _$httpBackend_, _$rootScope_) {
  ...
  it('should not interrupt errors that are not 404', function () {
    ...
    var rejected;
    currentRegistrationInterceptor.responseError(rejection).then(null, function () {
      rejected = true;
    });
  ...
  it('should interrupt a 404 from the current registration url', function () {
    ...
    var rejected;
    var resolved;
    currentRegistrationInterceptor.responseError(rejection).then(function () {
      resolved = true;
    }, function () {
      rejected = true;
    });
