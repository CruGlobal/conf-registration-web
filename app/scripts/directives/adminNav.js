        ...
        $scope.archiveEvent = function(conferenceId) {
          PermissionCache.getForConference(conferenceId).then(function(
            ...
            if (permissions.permissionInt < permissionConstants.FULL) {
              modalMessage.error(
                'You do not have permission to perform this action. Please contact an event admin to request permission.',
              );
              return;
            }
            ...
            modalMessage
              .confirm({
                title: 'Archive Event',
                question:
                  'Are you sure you want to archive this event? Events can be unarchived later.',
                yesString: 'Archive',
                noString: 'Cancel',
                normalSize: true,
              })
