            ...
            {showFilter('filterAccountTransferErrors') && (
              <div className="col-sm-3 stacked-spacing-col-sm">
                <label>
                  ...
                  >
                    <ToggleButton id="filter-yes" value="yes">
                      Show
                    </ToggleButton>
                    <ToggleButton id="filter-no" value="no">
                      Hide
                    </ToggleButton>
                    <ToggleButton id="filter-only" value="only">
                      Only
                    </ToggleButton>
                  </ToggleButtonGroup>
                </label>
            ...
            {showFilter('includeIncomplete') && (
              <div className="col-sm-3 stacked-spacing-col-sm">
                <label>
                  ...
                  >
                    <ToggleButton id="incomplete-yes" value="yes">
                      Show
                    </ToggleButton>
                    <ToggleButton id="incomplete-no" value="no">
                      Hide
                    </ToggleButton>
                    <ToggleButton id="incomplete-only" value="only">
                      Only
                    </ToggleButton>
                  </ToggleButtonGroup>
                </label>
            ...
            {showFilter('includeCheckedin') && (
              <div className="col-sm-3 stacked-spacing-col-sm">
                <label>
                  ...
                  >
                    <ToggleButton id="checkin-yes" value="yes">
                      Show
                    </ToggleButton>
                    <ToggleButton id="checkin-no" value="no">
                      Hide
                    </ToggleButton>
                    <ToggleButton id="checkin-only" value="only">
                      Only
                    </ToggleButton>
                  </ToggleButtonGroup>
                </label>
            ...
            {showFilter('includeWithdrawn') && (
              <div className="col-sm-3 stacked-spacing-col-sm">
                <label>
                  ...
                  >
                    <ToggleButton id="withdraw-yes" value="yes">
                      Show
                    </ToggleButton>
                    <ToggleButton id="withdraw-no" value="no">
                      Hide
                    </ToggleButton>
                    <ToggleButton id="withdraw-only" value="only">
                      Only
                    </ToggleButton>
                  </ToggleButtonGroup>
                </label>
        ...
        <div className="row spacing-above-xs">
          <div className="col-sm-4 spacing-xs spacing-above-md">
            ...
            >
              ...
              <ToggleButton id="limit-50" value={50}>
                50
              </ToggleButton>
