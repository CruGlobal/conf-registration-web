...
angular.module('wysiwyg.module', [])
    ...
    .factory('wysiwgGui', function() {
        ...
        var getMenuTextArea = function() {
            return '<div id="{{textareaId}}" style="resize:vertical; height:150px; overflow:auto;" contentEditable="true" class="{{textareaClass}} wysiwyg-textarea" rows="{{textareaRows}}" name="{{textareaName}}" required="{{textareaRequired}}" placeholder="{{textareaPlaceholder}}" ng-model="value"></div>';
        }
